# VibePilot Code Map
# Generated: 2026-04-17T02:11:35Z | Commit: 6ab5dd33
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: log, github.com/vibepilot/governor/internal/db, fmt, os, os/signal, time, syscall, context
  API:
    fn main()
...
handlers_council.go [495L]
  deps: context, errors, os, time, github.com/vibepilot/governor/internal/db, fmt, github.com/vibepilot/governor/internal/gitree, sync, encoding/json, github.com/vibepilot/governor/internal/runtime, log
...
handlers_maint.go [308L]
  deps: github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/db, context, github.com/vibepilot/governor/internal/runtime, time, log, encoding/json, fmt
...
handlers_plan.go [404L]
  deps: os, github.com/vibepilot/governor/internal/db, context, encoding/json, log, github.com/vibepilot/governor/internal/gitree, path/filepath, github.com/vibepilot/governor/internal/runtime, fmt, time
  API:
...
handlers_research.go [415L]
  deps: time, fmt, sync, github.com/vibepilot/governor/internal/runtime, log, encoding/json, github.com/vibepilot/governor/internal/db, context
...
handlers_task.go [706L]
  deps: strings, time, github.com/vibepilot/governor/internal/core, context, github.com/vibepilot/governor/internal/runtime, fmt, log, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, encoding/json
...
handlers_testing.go [260L]
  deps: strings, encoding/json, time, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, context, log, github.com/vibepilot/governor/internal/runtime, fmt
...
main.go [326L]
  deps: github.com/vibepilot/governor/internal/connectors, log, os/signal, path/filepath, github.com/vibepilot/governor/internal/realtime, github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/tools, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/dag, os, github.com/vibepilot/governor/internal/mcp, syscall, time, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/core, context, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/webhooks
  API:
    fn main()
...
recovery.go [293L]
  deps: github.com/vibepilot/governor/internal/db, log, time, encoding/json, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/runtime, fmt, context
  API:
...
smoke.go [252L]
  deps: time, fmt, net/http, encoding/json, io, log, bytes, os
  API:
...
startup_validate.go [410L]
  deps: os, log, time, strings, fmt, context, os/exec, path/filepath, encoding/json
  API:
...
validation.go [377L]
  deps: fmt, github.com/vibepilot/governor/internal/runtime, log, encoding/json, strconv, github.com/vibepilot/governor/internal/db, regexp, path/filepath, strings, context, github.com/vibepilot/governor/internal/gitree, os
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: crypto/aes, io, encoding/json, crypto/cipher, golang.org/x/crypto/pbkdf2, net/http, log, fmt, os, crypto/rand, encoding/base64, crypto/sha256, bytes
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [239L]
  deps: net/http, fmt, context, io, encoding/json, time, bytes
...
runners.go [487L]
  deps: bytes, os/exec, bufio, context, encoding/json, io, net/http, time, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault, fmt, strings
...
test_runner.go [296L]
  deps: context, fmt, strings, os, path/filepath, os/exec, time, encoding/json
...
engine.go [233L]
  deps: context, time, fmt, strings, log, sync
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
supabase.go [285L]
  deps: encoding/json, net/http, context, bytes, fmt, regexp, strings, net/url, io, time
...
gitree.go [484L]
  deps: bytes, log, time, encoding/json, strings, fmt, context, path/filepath, regexp, os/exec, os
  exports: New
  API:
...
worktree.go [405L]
  deps: fmt, path/filepath, regexp, strings, time, log, os, context
...
maintenance.go [346L]
  deps: github.com/vibepilot/governor/internal/db, fmt, path/filepath, os, strings, github.com/vibepilot/governor/internal/gitree, log, context, github.com/vibepilot/governor/pkg/types
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: os, fmt, context, time, log, io, os/exec, path/filepath
  API:
...
validation.go [248L]
  deps: strings, encoding/json, log, path/filepath, fmt, os, time
  API:
...
governor_server.go [211L]
  deps: github.com/vibepilot/governor/internal/runtime, encoding/json, fmt, log, strconv, os, github.com/mark3labs/mcp-go/server, context, github.com/mark3labs/mcp-go/mcp
...
registry.go [253L]
  deps: github.com/mark3labs/mcp-go/client/transport, github.com/vibepilot/governor/internal/runtime, sync, time, github.com/mark3labs/mcp-go/mcp, context, github.com/mark3labs/mcp-go/client, fmt, log, encoding/json
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: github.com/vibepilot/governor/internal/db, context, fmt, strings, github.com/vibepilot/governor/internal/runtime, encoding/json, time
...
client.go [640L]
  deps: context, encoding/json, github.com/vibepilot/governor/internal/runtime, time, net/url, sync, github.com/coder/websocket, net/http, fmt, log
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1161L]
  deps: sync, context, encoding/json, os, log, path/filepath, fmt
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
model_loader.go [217L]
  deps: time, os, context, path/filepath, github.com/vibepilot/governor/internal/db, fmt, encoding/json
...
parallel.go [230L]
  deps: context, sync/atomic, log, sync, fmt
...
session.go [243L]
  deps: fmt, encoding/json, time, strings, context
...
usage_tracker.go [450L]
  deps: fmt, context, encoding/json, time, sync
...
db_tools.go [255L]
  deps: regexp, context, github.com/vibepilot/governor/internal/db, encoding/json, fmt, strings
...
file_tools.go [177L]
  deps: fmt, os, context, encoding/json, strings, path/filepath
...
registry.go [94L]
  deps: github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, time, github.com/vibepilot/governor/internal/vault, net/http
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: context, time, os, strings, bytes, path/filepath, os/exec, fmt, encoding/json
...
web_tools.go [231L]
  deps: net/http, io, strings, context, encoding/json, fmt, github.com/vibepilot/governor/internal/runtime, net/url
...
vault.go [337L]
  deps: encoding/json, crypto/cipher, crypto/sha256, os, github.com/vibepilot/governor/internal/db, crypto/rand, encoding/base64, context, sync, time, log, fmt, crypto/aes, golang.org/x/crypto/pbkdf2, io
...
server.go [303L]
  deps: fmt, context, crypto/hmac, net/http, log, time, strings, io, crypto/sha256, github.com/vibepilot/governor/internal/runtime, encoding/json, encoding/hex
