# VibePilot Code Map
# Generated: 2026-04-21T04:15:26Z | Commit: bff45f30
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: context, syscall, log, os, os/signal, fmt, github.com/vibepilot/governor/internal/db, time
  API:
    fn main()
...
handlers_council.go [582L]
  deps: github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/gitree, context, encoding/json, fmt, sync, log, time, os, github.com/vibepilot/governor/internal/db, errors
...
handlers_maint.go [337L]
  deps: fmt, github.com/vibepilot/governor/internal/gitree, time, github.com/vibepilot/governor/internal/db, log, github.com/vibepilot/governor/internal/runtime, context, encoding/json
...
handlers_plan.go [576L]
  deps: github.com/vibepilot/governor/internal/db, path/filepath, os, log, encoding/json, github.com/vibepilot/governor/internal/runtime, time, github.com/vibepilot/governor/internal/gitree, fmt, context
  API:
...
handlers_research.go [446L]
  deps: encoding/json, sync, time, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, fmt, log, context
...
handlers_task.go [1317L]
  deps: os, github.com/vibepilot/governor/internal/runtime, encoding/json, log, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/security, time, context, strings, fmt, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/connectors
...
handlers_testing.go [604L]
  deps: github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/gitree, fmt, log, os, strings, os/exec, path/filepath, encoding/json, context, bytes, time, github.com/vibepilot/governor/internal/db
...
helpers.go [100L]
  deps: context, log, encoding/json, github.com/vibepilot/governor/internal/db
  API:
...
main.go [392L]
  deps: github.com/vibepilot/governor/internal/vault, path/filepath, encoding/json, time, github.com/vibepilot/governor/internal/tools, context, syscall, log, github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/realtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, os/signal, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/dag, github.com/vibepilot/governor/internal/webhooks, os, github.com/vibepilot/governor/internal/mcp
  API:
    fn main()
...
recovery.go [384L]
  deps: context, encoding/json, github.com/vibepilot/governor/internal/runtime, fmt, github.com/vibepilot/governor/internal/core, log, github.com/vibepilot/governor/internal/db, time
  API:
...
smoke.go [252L]
  deps: log, fmt, encoding/json, time, net/http, bytes, os, io
  API:
...
startup_validate.go [503L]
  deps: fmt, time, path/filepath, log, os/exec, strings, context, encoding/json, os
  API:
...
validation.go [395L]
  deps: github.com/vibepilot/governor/internal/gitree, strings, strconv, context, encoding/json, fmt, regexp, path/filepath, log, github.com/vibepilot/governor/internal/db, os, github.com/vibepilot/governor/internal/runtime
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: io, crypto/cipher, golang.org/x/crypto/pbkdf2, encoding/base64, bytes, crypto/aes, crypto/rand, encoding/json, log, fmt, net/http, os, crypto/sha256
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [258L]
  deps: io, sync, context, net/http, bytes, fmt, encoding/json, time
...
runners.go [497L]
  deps: time, bytes, io, net/http, os/exec, bufio, fmt, strings, context, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault, encoding/json
...
state.go [302L]
  deps: sync, fmt, time, context, encoding/json
...
test_runner.go [296L]
  deps: os/exec, strings, fmt, encoding/json, os, path/filepath, time, context
...
engine.go [233L]
  deps: sync, context, time, log, strings, fmt
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
supabase.go [285L]
  deps: context, regexp, net/http, fmt, bytes, net/url, io, encoding/json, strings, time
...
gitree.go [499L]
  deps: strings, path/filepath, bytes, time, log, regexp, os/exec, context, encoding/json, os, fmt
  exports: New
  API:
...
worktree.go [411L]
  deps: os, log, strings, context, regexp, path/filepath, fmt, time
...
maintenance.go [346L]
  deps: os, github.com/vibepilot/governor/pkg/types, log, path/filepath, strings, context, github.com/vibepilot/governor/internal/gitree, fmt, github.com/vibepilot/governor/internal/db
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: io, fmt, time, os, os/exec, path/filepath, log, context
  API:
...
validation.go [248L]
  deps: time, fmt, path/filepath, os, log, strings, encoding/json
  API:
...
governor_server.go [211L]
  deps: context, fmt, strconv, github.com/mark3labs/mcp-go/mcp, github.com/vibepilot/governor/internal/runtime, encoding/json, github.com/mark3labs/mcp-go/server, log, os
...
registry.go [253L]
  deps: log, github.com/mark3labs/mcp-go/mcp, encoding/json, fmt, sync, github.com/vibepilot/governor/internal/runtime, time, github.com/mark3labs/mcp-go/client, github.com/mark3labs/mcp-go/client/transport, context
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: github.com/vibepilot/governor/internal/db, fmt, encoding/json, strings, time, github.com/vibepilot/governor/internal/runtime, context
...
service.go [276L]
  deps: context, encoding/json, github.com/vibepilot/governor/internal/db, fmt, time
  exports: New
  API:
    cl ⊛ Config
    cl ⊛ Rule
...
client.go [648L]
  deps: encoding/json, fmt, sync, context, log, net/http, time, net/url, github.com/coder/websocket, github.com/vibepilot/governor/internal/runtime
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1175L]
  deps: path/filepath, encoding/json, context, fmt, log, os, sync
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
connector_tracker.go [283L]
  deps: time, log, context, sync, encoding/json
...
model_loader.go [364L]
  deps: log, path/filepath, os, context, github.com/vibepilot/governor/internal/db, time, fmt, encoding/json
...
platform_tracker.go [361L]
  deps: time, sync, encoding/json, context, log
...
session.go [243L]
  deps: strings, encoding/json, time, fmt, context
...
usage_tracker.go [786L]
  deps: sync, time, fmt, encoding/json, context, log
...
db_tools.go [255L]
  deps: encoding/json, fmt, context, strings, github.com/vibepilot/governor/internal/db, regexp
...
file_tools.go [177L]
  deps: fmt, encoding/json, context, os, path/filepath, strings
...
registry.go [94L]
  deps: time, github.com/vibepilot/governor/internal/runtime, net/http, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/gitree
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: bytes, os, context, os/exec, fmt, path/filepath, encoding/json, time, strings
...
web_tools.go [231L]
  deps: encoding/json, net/http, net/url, strings, fmt, io, context, github.com/vibepilot/governor/internal/runtime
...
vault.go [337L]
  deps: crypto/sha256, golang.org/x/crypto/pbkdf2, fmt, crypto/cipher, crypto/aes, io, log, encoding/base64, crypto/rand, github.com/vibepilot/governor/internal/db, sync, time, context, encoding/json, os
...
server.go [327L]
  deps: log, net/http, encoding/hex, strings, github.com/vibepilot/governor/internal/runtime, encoding/json, time, io, fmt, context, crypto/sha256, crypto/hmac
