# VibePilot Code Map
# Generated: 2026-04-17T20:16:26Z | Commit: e11b10c3
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: os, log, github.com/vibepilot/governor/internal/db, os/signal, time, context, fmt, syscall
  API:
    fn main()
...
handlers_council.go [495L]
  deps: encoding/json, fmt, errors, context, sync, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, os, time, log
...
handlers_maint.go [308L]
  deps: context, time, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, fmt, github.com/vibepilot/governor/internal/runtime, encoding/json, log
...
handlers_plan.go [404L]
  deps: time, encoding/json, github.com/vibepilot/governor/internal/runtime, path/filepath, context, log, github.com/vibepilot/governor/internal/db, fmt, os, github.com/vibepilot/governor/internal/gitree
  API:
...
handlers_research.go [415L]
  deps: github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, sync, encoding/json, context, time, log, fmt
...
handlers_task.go [707L]
  deps: log, context, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/security, time, github.com/vibepilot/governor/internal/core, fmt, github.com/vibepilot/governor/internal/db, strings, encoding/json, github.com/vibepilot/governor/internal/runtime
...
handlers_testing.go [260L]
  deps: strings, encoding/json, context, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, log, fmt, time, github.com/vibepilot/governor/internal/runtime
...
main.go [326L]
  deps: os/signal, path/filepath, syscall, github.com/vibepilot/governor/internal/webhooks, github.com/vibepilot/governor/internal/tools, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/mcp, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/dag, github.com/vibepilot/governor/internal/security, os, log, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/realtime, time, context
  API:
    fn main()
...
recovery.go [293L]
  deps: github.com/vibepilot/governor/internal/db, time, github.com/vibepilot/governor/internal/core, fmt, context, github.com/vibepilot/governor/internal/runtime, log, encoding/json
  API:
...
smoke.go [252L]
  deps: io, log, bytes, fmt, os, net/http, encoding/json, time
  API:
...
startup_validate.go [438L]
  deps: encoding/json, context, os, os/exec, time, fmt, log, strings, path/filepath
  API:
...
validation.go [377L]
  deps: log, os, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, strconv, fmt, regexp, encoding/json, strings, context, path/filepath, github.com/vibepilot/governor/internal/gitree
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: encoding/base64, crypto/sha256, os, crypto/aes, golang.org/x/crypto/pbkdf2, crypto/rand, encoding/json, log, net/http, bytes, fmt, crypto/cipher, io
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [239L]
  deps: context, bytes, encoding/json, io, fmt, net/http, time
...
runners.go [487L]
  deps: bufio, encoding/json, fmt, bytes, net/http, time, os/exec, github.com/vibepilot/governor/internal/vault, context, strings, io, github.com/vibepilot/governor/internal/runtime
...
test_runner.go [296L]
  deps: encoding/json, os, fmt, path/filepath, strings, time, context, os/exec
...
engine.go [233L]
  deps: strings, fmt, time, context, log, sync
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
supabase.go [285L]
  deps: fmt, time, net/url, regexp, context, strings, encoding/json, io, net/http, bytes
...
gitree.go [484L]
  deps: regexp, log, bytes, encoding/json, context, os, os/exec, strings, time, fmt, path/filepath
  exports: New
  API:
...
worktree.go [405L]
  deps: context, regexp, log, fmt, path/filepath, strings, time, os
...
maintenance.go [346L]
  deps: github.com/vibepilot/governor/internal/gitree, context, strings, log, path/filepath, github.com/vibepilot/governor/internal/db, os, github.com/vibepilot/governor/pkg/types, fmt
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: fmt, log, time, os/exec, os, io, path/filepath, context
  API:
...
validation.go [248L]
  deps: fmt, log, path/filepath, encoding/json, strings, time, os
  API:
...
governor_server.go [211L]
  deps: fmt, strconv, context, github.com/mark3labs/mcp-go/server, log, github.com/mark3labs/mcp-go/mcp, encoding/json, os, github.com/vibepilot/governor/internal/runtime
...
registry.go [253L]
  deps: time, github.com/mark3labs/mcp-go/client, github.com/mark3labs/mcp-go/client/transport, context, encoding/json, fmt, sync, log, github.com/mark3labs/mcp-go/mcp, github.com/vibepilot/governor/internal/runtime
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: github.com/vibepilot/governor/internal/db, context, fmt, strings, encoding/json, github.com/vibepilot/governor/internal/runtime, time
...
client.go [640L]
  deps: context, fmt, sync, encoding/json, time, github.com/vibepilot/governor/internal/runtime, github.com/coder/websocket, net/http, net/url, log
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1161L]
  deps: os, fmt, path/filepath, sync, context, encoding/json, log
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
model_loader.go [217L]
  deps: path/filepath, github.com/vibepilot/governor/internal/db, context, time, encoding/json, os, fmt
...
db_tools.go [255L]
  deps: github.com/vibepilot/governor/internal/db, encoding/json, regexp, context, strings, fmt
...
file_tools.go [177L]
  deps: context, encoding/json, path/filepath, os, strings, fmt
...
sandbox_tools.go [245L]
  deps: encoding/json, bytes, os/exec, fmt, context, time, strings, path/filepath, os
...
web_tools.go [231L]
  deps: context, encoding/json, github.com/vibepilot/governor/internal/runtime, net/http, fmt, strings, net/url, io
...
vault.go [337L]
  deps: crypto/rand, log, context, crypto/sha256, encoding/json, sync, time, io, github.com/vibepilot/governor/internal/db, crypto/aes, crypto/cipher, golang.org/x/crypto/pbkdf2, os, encoding/base64, fmt
...
server.go [303L]
  deps: github.com/vibepilot/governor/internal/runtime, context, encoding/hex, crypto/hmac, time, fmt, io, net/http, log, encoding/json, strings, crypto/sha256
