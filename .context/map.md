# VibePilot Code Map
# Generated: 2026-04-17T20:20:09Z | Commit: e0778923
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: context, fmt, time, os/signal, log, os, github.com/vibepilot/governor/internal/db, syscall
  API:
    fn main()
...
handlers_council.go [495L]
  deps: errors, github.com/vibepilot/governor/internal/db, encoding/json, github.com/vibepilot/governor/internal/gitree, os, github.com/vibepilot/governor/internal/runtime, fmt, time, log, context, sync
...
handlers_maint.go [308L]
  deps: time, encoding/json, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, context, github.com/vibepilot/governor/internal/gitree, fmt, log
...
handlers_plan.go [404L]
  deps: github.com/vibepilot/governor/internal/runtime, time, encoding/json, fmt, log, context, path/filepath, github.com/vibepilot/governor/internal/db, os, github.com/vibepilot/governor/internal/gitree
  API:
...
handlers_research.go [415L]
  deps: log, time, github.com/vibepilot/governor/internal/runtime, encoding/json, sync, github.com/vibepilot/governor/internal/db, context, fmt
...
handlers_task.go [707L]
  deps: github.com/vibepilot/governor/internal/runtime, time, github.com/vibepilot/governor/internal/core, log, fmt, context, github.com/vibepilot/governor/internal/gitree, strings, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/db, encoding/json
...
handlers_testing.go [260L]
  deps: fmt, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, context, github.com/vibepilot/governor/internal/db, log, encoding/json, strings, time
...
main.go [326L]
  deps: context, time, log, github.com/vibepilot/governor/internal/realtime, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/webhooks, syscall, github.com/vibepilot/governor/internal/mcp, path/filepath, github.com/vibepilot/governor/internal/dag, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/tools, os/signal, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/security, os, github.com/vibepilot/governor/internal/memory
  API:
    fn main()
...
recovery.go [293L]
  deps: encoding/json, time, log, fmt, context, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/core
  API:
...
smoke.go [252L]
  deps: time, bytes, net/http, encoding/json, log, os, io, fmt
  API:
...
startup_validate.go [438L]
  deps: os/exec, fmt, os, path/filepath, context, log, encoding/json, strings, time
  API:
...
validation.go [377L]
  deps: github.com/vibepilot/governor/internal/db, strings, log, os, regexp, path/filepath, github.com/vibepilot/governor/internal/gitree, encoding/json, strconv, github.com/vibepilot/governor/internal/runtime, context, fmt
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: crypto/aes, crypto/cipher, encoding/base64, net/http, encoding/json, crypto/sha256, log, golang.org/x/crypto/pbkdf2, io, os, bytes, crypto/rand, fmt
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [239L]
  deps: bytes, fmt, io, net/http, time, encoding/json, context
...
runners.go [487L]
  deps: time, github.com/vibepilot/governor/internal/vault, fmt, bytes, github.com/vibepilot/governor/internal/runtime, context, os/exec, bufio, encoding/json, io, strings, net/http
...
state.go [302L]
  deps: sync, fmt, time, encoding/json, context
...
test_runner.go [296L]
  deps: time, path/filepath, context, fmt, strings, encoding/json, os, os/exec
...
supabase.go [285L]
  deps: net/url, time, io, bytes, fmt, net/http, regexp, context, strings, encoding/json
...
gitree.go [484L]
  deps: bytes, os/exec, path/filepath, os, fmt, encoding/json, log, context, time, strings, regexp
  exports: New
  API:
...
worktree.go [405L]
  deps: os, context, regexp, log, path/filepath, strings, time, fmt
...
maintenance.go [346L]
  deps: os, context, github.com/vibepilot/governor/pkg/types, strings, log, fmt, path/filepath, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: log, path/filepath, os, io, context, os/exec, fmt, time
  API:
...
validation.go [248L]
  deps: path/filepath, fmt, time, strings, encoding/json, os, log
  API:
...
governor_server.go [211L]
  deps: log, strconv, github.com/mark3labs/mcp-go/mcp, context, fmt, encoding/json, os, github.com/mark3labs/mcp-go/server, github.com/vibepilot/governor/internal/runtime
...
registry.go [253L]
  deps: context, encoding/json, github.com/vibepilot/governor/internal/runtime, github.com/mark3labs/mcp-go/client/transport, log, fmt, sync, github.com/mark3labs/mcp-go/mcp, time, github.com/mark3labs/mcp-go/client
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: github.com/vibepilot/governor/internal/db, fmt, context, strings, time, encoding/json, github.com/vibepilot/governor/internal/runtime
...
service.go [276L]
  deps: fmt, github.com/vibepilot/governor/internal/db, context, time, encoding/json
  exports: New
  API:
    cl ⊛ Config
    cl ⊛ Rule
...
client.go [640L]
  deps: log, net/url, time, github.com/coder/websocket, sync, github.com/vibepilot/governor/internal/runtime, fmt, encoding/json, context, net/http
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1161L]
  deps: encoding/json, context, fmt, log, path/filepath, os, sync
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
model_loader.go [217L]
  deps: path/filepath, context, encoding/json, os, time, github.com/vibepilot/governor/internal/db, fmt
...
session.go [243L]
  deps: time, context, strings, encoding/json, fmt
...
usage_tracker.go [450L]
  deps: context, sync, fmt, encoding/json, time
...
file_tools.go [177L]
  deps: path/filepath, strings, fmt, context, os, encoding/json
...
registry.go [94L]
  deps: github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/gitree, net/http, time
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: strings, bytes, context, fmt, time, path/filepath, encoding/json, os, os/exec
...
web_tools.go [231L]
  deps: github.com/vibepilot/governor/internal/runtime, net/url, context, io, encoding/json, strings, net/http, fmt
...
vault.go [337L]
  deps: golang.org/x/crypto/pbkdf2, encoding/base64, sync, crypto/sha256, crypto/aes, io, time, log, github.com/vibepilot/governor/internal/db, fmt, crypto/rand, crypto/cipher, encoding/json, os, context
...
server.go [303L]
  deps: fmt, context, log, net/http, crypto/sha256, io, time, strings, crypto/hmac, encoding/json, github.com/vibepilot/governor/internal/runtime, encoding/hex
