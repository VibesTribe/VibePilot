# VibePilot Code Map
# Generated: 2026-04-17T02:22:31Z | Commit: a4db6e17
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: time, os/signal, fmt, os, log, github.com/vibepilot/governor/internal/db, syscall, context
  API:
    fn main()
...
handlers_council.go [495L]
  deps: os, encoding/json, github.com/vibepilot/governor/internal/runtime, errors, github.com/vibepilot/governor/internal/gitree, context, sync, fmt, time, log, github.com/vibepilot/governor/internal/db
...
handlers_maint.go [308L]
  deps: time, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, fmt, context, log, encoding/json, github.com/vibepilot/governor/internal/gitree
...
handlers_plan.go [404L]
  deps: fmt, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, encoding/json, os, context, log, time, github.com/vibepilot/governor/internal/gitree, path/filepath
  API:
...
handlers_research.go [415L]
  deps: log, github.com/vibepilot/governor/internal/runtime, sync, context, encoding/json, fmt, time, github.com/vibepilot/governor/internal/db
...
handlers_task.go [706L]
  deps: context, github.com/vibepilot/governor/internal/security, time, github.com/vibepilot/governor/internal/core, encoding/json, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, strings, fmt, log
...
handlers_testing.go [260L]
  deps: fmt, log, github.com/vibepilot/governor/internal/gitree, strings, github.com/vibepilot/governor/internal/runtime, encoding/json, context, github.com/vibepilot/governor/internal/db, time
...
main.go [326L]
  deps: github.com/vibepilot/governor/internal/gitree, context, github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/realtime, time, github.com/vibepilot/governor/internal/mcp, github.com/vibepilot/governor/internal/webhooks, github.com/vibepilot/governor/internal/dag, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/tools, log, os, path/filepath, github.com/vibepilot/governor/internal/security, os/signal, syscall, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/connectors
  API:
    fn main()
...
recovery.go [293L]
  deps: github.com/vibepilot/governor/internal/core, time, context, encoding/json, github.com/vibepilot/governor/internal/runtime, fmt, log, github.com/vibepilot/governor/internal/db
  API:
...
smoke.go [252L]
  deps: log, os, fmt, io, bytes, net/http, encoding/json, time
  API:
...
startup_validate.go [438L]
  deps: encoding/json, path/filepath, fmt, log, os, context, os/exec, time, strings
  API:
...
validation.go [377L]
  deps: log, context, strconv, strings, os, path/filepath, fmt, regexp, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/gitree, encoding/json
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: golang.org/x/crypto/pbkdf2, encoding/json, os, crypto/aes, crypto/cipher, log, crypto/sha256, crypto/rand, fmt, bytes, io, net/http, encoding/base64
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [239L]
  deps: context, io, fmt, encoding/json, net/http, bytes, time
...
runners.go [487L]
  deps: strings, bytes, net/http, time, bufio, context, fmt, encoding/json, io, os/exec, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault
...
test_runner.go [296L]
  deps: os, os/exec, fmt, path/filepath, time, encoding/json, strings, context
...
engine.go [233L]
  deps: strings, fmt, sync, time, log, context
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
supabase.go [285L]
  deps: bytes, regexp, io, encoding/json, strings, context, fmt, net/http, net/url, time
...
gitree.go [484L]
  deps: fmt, bytes, os, regexp, path/filepath, os/exec, context, log, time, strings, encoding/json
  exports: New
  API:
...
worktree.go [405L]
  deps: fmt, log, time, strings, regexp, path/filepath, os, context
...
maintenance.go [346L]
  deps: strings, github.com/vibepilot/governor/internal/gitree, fmt, log, os, github.com/vibepilot/governor/pkg/types, github.com/vibepilot/governor/internal/db, path/filepath, context
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: io, path/filepath, os/exec, time, os, log, context, fmt
  API:
...
validation.go [248L]
  deps: strings, path/filepath, time, os, fmt, log, encoding/json
  API:
...
governor_server.go [211L]
  deps: encoding/json, github.com/mark3labs/mcp-go/server, log, strconv, github.com/vibepilot/governor/internal/runtime, context, fmt, os, github.com/mark3labs/mcp-go/mcp
...
registry.go [253L]
  deps: sync, context, github.com/mark3labs/mcp-go/mcp, encoding/json, github.com/vibepilot/governor/internal/runtime, log, github.com/mark3labs/mcp-go/client, time, fmt, github.com/mark3labs/mcp-go/client/transport
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: github.com/vibepilot/governor/internal/db, context, time, encoding/json, strings, fmt, github.com/vibepilot/governor/internal/runtime
...
client.go [640L]
  deps: time, fmt, log, encoding/json, context, net/http, net/url, sync, github.com/coder/websocket, github.com/vibepilot/governor/internal/runtime
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1161L]
  deps: sync, fmt, log, context, path/filepath, encoding/json, os
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
model_loader.go [217L]
  deps: context, fmt, os, time, path/filepath, github.com/vibepilot/governor/internal/db, encoding/json
...
db_tools.go [255L]
  deps: encoding/json, strings, fmt, github.com/vibepilot/governor/internal/db, context, regexp
...
file_tools.go [177L]
  deps: strings, os, context, fmt, encoding/json, path/filepath
...
registry.go [94L]
  deps: time, github.com/vibepilot/governor/internal/gitree, net/http, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/vault
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: encoding/json, context, os/exec, path/filepath, strings, os, bytes, time, fmt
...
web_tools.go [231L]
  deps: context, strings, io, fmt, encoding/json, net/url, github.com/vibepilot/governor/internal/runtime, net/http
...
vault.go [337L]
  deps: golang.org/x/crypto/pbkdf2, crypto/rand, context, encoding/base64, crypto/cipher, github.com/vibepilot/governor/internal/db, encoding/json, os, io, log, time, crypto/sha256, fmt, sync, crypto/aes
...
server.go [303L]
  deps: net/http, encoding/json, encoding/hex, log, fmt, strings, context, github.com/vibepilot/governor/internal/runtime, crypto/sha256, time, crypto/hmac, io
