# VibePilot Code Map
# Generated: 2026-04-18T03:51:54Z | Commit: 42650af1
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: fmt, os, time, os/signal, log, github.com/vibepilot/governor/internal/db, syscall, context
  API:
    fn main()
...
handlers_council.go [495L]
  deps: os, sync, time, github.com/vibepilot/governor/internal/gitree, log, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, context, encoding/json, fmt, errors
...
handlers_maint.go [308L]
  deps: encoding/json, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, fmt, log, time, context, github.com/vibepilot/governor/internal/runtime
...
handlers_plan.go [414L]
  deps: log, fmt, os, encoding/json, path/filepath, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, context, time, github.com/vibepilot/governor/internal/db
  API:
...
handlers_research.go [415L]
  deps: github.com/vibepilot/governor/internal/db, sync, fmt, github.com/vibepilot/governor/internal/runtime, context, time, encoding/json, log
...
handlers_task.go [853L]
  deps: time, encoding/json, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/security, log, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/gitree, fmt, context, strings
...
handlers_testing.go [260L]
  deps: github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, context, log, fmt, time, encoding/json, github.com/vibepilot/governor/internal/runtime, strings
...
main.go [326L]
  deps: github.com/vibepilot/governor/internal/dag, path/filepath, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/webhooks, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault, syscall, os, context, github.com/vibepilot/governor/internal/realtime, github.com/vibepilot/governor/internal/tools, os/signal, time, github.com/vibepilot/governor/internal/mcp, github.com/vibepilot/governor/internal/core, log
  API:
    fn main()
...
recovery.go [293L]
  deps: context, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/db, encoding/json, log, github.com/vibepilot/governor/internal/runtime, fmt, time
  API:
...
smoke.go [252L]
  deps: log, os, time, net/http, encoding/json, io, fmt, bytes
  API:
...
startup_validate.go [438L]
  deps: fmt, encoding/json, path/filepath, log, context, os, os/exec, strings, time
  API:
...
validation.go [377L]
  deps: log, fmt, regexp, encoding/json, strings, github.com/vibepilot/governor/internal/gitree, context, os, github.com/vibepilot/governor/internal/db, strconv, github.com/vibepilot/governor/internal/runtime, path/filepath
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: encoding/base64, log, crypto/aes, bytes, crypto/cipher, crypto/rand, fmt, io, encoding/json, net/http, golang.org/x/crypto/pbkdf2, crypto/sha256, os
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [239L]
  deps: encoding/json, io, bytes, context, net/http, fmt, time
...
runners.go [487L]
  deps: fmt, os/exec, context, bufio, bytes, io, strings, github.com/vibepilot/governor/internal/runtime, encoding/json, github.com/vibepilot/governor/internal/vault, net/http, time
...
test_runner.go [296L]
  deps: os/exec, time, path/filepath, context, encoding/json, strings, fmt, os
...
engine.go [233L]
  deps: context, sync, strings, time, log, fmt
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
supabase.go [285L]
  deps: context, encoding/json, io, net/url, regexp, fmt, net/http, time, strings, bytes
...
gitree.go [489L]
  deps: time, fmt, os/exec, regexp, strings, encoding/json, log, bytes, os, context, path/filepath
  exports: New
  API:
...
worktree.go [411L]
  deps: os, fmt, context, strings, time, log, path/filepath, regexp
...
maintenance.go [346L]
  deps: context, os, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/pkg/types, fmt, github.com/vibepilot/governor/internal/db, path/filepath, strings, log
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: context, fmt, io, path/filepath, os, log, time, os/exec
  API:
...
validation.go [248L]
  deps: time, strings, log, encoding/json, fmt, os, path/filepath
  API:
...
governor_server.go [211L]
  deps: os, github.com/vibepilot/governor/internal/runtime, fmt, github.com/mark3labs/mcp-go/server, strconv, log, context, github.com/mark3labs/mcp-go/mcp, encoding/json
...
registry.go [253L]
  deps: sync, encoding/json, github.com/vibepilot/governor/internal/runtime, github.com/mark3labs/mcp-go/mcp, time, github.com/mark3labs/mcp-go/client, log, fmt, github.com/mark3labs/mcp-go/client/transport, context
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: github.com/vibepilot/governor/internal/db, context, encoding/json, strings, time, github.com/vibepilot/governor/internal/runtime, fmt
...
client.go [640L]
  deps: github.com/vibepilot/governor/internal/runtime, sync, net/url, context, net/http, fmt, log, github.com/coder/websocket, time, encoding/json
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1161L]
  deps: context, encoding/json, os, fmt, log, path/filepath, sync
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
model_loader.go [217L]
  deps: encoding/json, github.com/vibepilot/governor/internal/db, path/filepath, context, fmt, time, os
...
db_tools.go [255L]
  deps: github.com/vibepilot/governor/internal/db, fmt, regexp, context, encoding/json, strings
...
registry.go [94L]
  deps: github.com/vibepilot/governor/internal/gitree, time, net/http, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/db
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: path/filepath, os/exec, os, encoding/json, strings, bytes, context, fmt, time
...
web_tools.go [231L]
  deps: encoding/json, net/http, github.com/vibepilot/governor/internal/runtime, net/url, context, strings, fmt, io
...
vault.go [337L]
  deps: crypto/rand, io, log, os, sync, encoding/base64, encoding/json, context, fmt, golang.org/x/crypto/pbkdf2, crypto/aes, crypto/sha256, time, crypto/cipher, github.com/vibepilot/governor/internal/db
...
server.go [303L]
  deps: fmt, log, crypto/hmac, crypto/sha256, io, context, encoding/hex, encoding/json, net/http, strings, time, github.com/vibepilot/governor/internal/runtime
