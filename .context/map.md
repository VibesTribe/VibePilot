# VibePilot Code Map
# Generated: 2026-04-18T04:20:07Z | Commit: 992895e2
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [65L]
  deps: log, os/signal, fmt, context, os, syscall, time, github.com/vibepilot/governor/internal/db
  API:
    fn main()
...
handlers_council.go [495L]
  deps: sync, errors, github.com/vibepilot/governor/internal/gitree, os, github.com/vibepilot/governor/internal/db, log, time, fmt, github.com/vibepilot/governor/internal/runtime, context, encoding/json
...
handlers_maint.go [308L]
  deps: github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/db, fmt, log, context, time, encoding/json, github.com/vibepilot/governor/internal/runtime
...
handlers_plan.go [414L]
  deps: fmt, os, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/gitree, log, context, encoding/json, time, github.com/vibepilot/governor/internal/db, path/filepath
  API:
...
handlers_research.go [415L]
  deps: time, context, fmt, encoding/json, log, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, sync
...
handlers_task.go [853L]
  deps: github.com/vibepilot/governor/internal/gitree, strings, github.com/vibepilot/governor/internal/core, encoding/json, context, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/security, time, fmt, log, github.com/vibepilot/governor/internal/runtime
...
handlers_testing.go [260L]
  deps: github.com/vibepilot/governor/internal/runtime, context, encoding/json, fmt, time, log, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, strings
...
main.go [326L]
  deps: github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/webhooks, github.com/vibepilot/governor/internal/mcp, time, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/tools, github.com/vibepilot/governor/internal/db, os, github.com/vibepilot/governor/internal/runtime, os/signal, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/dag, log, context, syscall, github.com/vibepilot/governor/internal/realtime, path/filepath, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/vault
  API:
    fn main()
...
recovery.go [293L]
  deps: github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/db, fmt, github.com/vibepilot/governor/internal/runtime, encoding/json, log, time, context
  API:
...
smoke.go [252L]
  deps: log, time, io, encoding/json, fmt, bytes, os, net/http
  API:
...
startup_validate.go [438L]
  deps: encoding/json, os/exec, strings, time, fmt, context, path/filepath, log, os
  API:
...
validation.go [377L]
  deps: fmt, github.com/vibepilot/governor/internal/db, encoding/json, context, path/filepath, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, os, log, strconv, strings, regexp
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [197L]
  deps: crypto/sha256, log, golang.org/x/crypto/pbkdf2, crypto/rand, fmt, crypto/aes, net/http, encoding/json, bytes, crypto/cipher, io, encoding/base64, os
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [239L]
  deps: net/http, time, context, fmt, io, bytes, encoding/json
...
runners.go [487L]
  deps: strings, github.com/vibepilot/governor/internal/runtime, bufio, fmt, io, github.com/vibepilot/governor/internal/vault, bytes, os/exec, net/http, encoding/json, time, context
...
test_runner.go [296L]
  deps: os, fmt, os/exec, time, strings, path/filepath, encoding/json, context
...
engine.go [233L]
  deps: context, fmt, sync, strings, time, log
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
supabase.go [285L]
  deps: net/http, io, bytes, net/url, time, context, fmt, regexp, strings, encoding/json
...
gitree.go [489L]
  deps: time, strings, os/exec, context, bytes, log, path/filepath, fmt, regexp, os, encoding/json
  exports: New
  API:
...
worktree.go [411L]
  deps: log, regexp, fmt, context, os, time, strings, path/filepath
...
maintenance.go [346L]
  deps: path/filepath, github.com/vibepilot/governor/pkg/types, github.com/vibepilot/governor/internal/db, os, strings, context, fmt, github.com/vibepilot/governor/internal/gitree, log
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: io, log, time, path/filepath, context, os/exec, os, fmt
  API:
...
validation.go [248L]
  deps: time, fmt, log, encoding/json, os, path/filepath, strings
  API:
...
governor_server.go [211L]
  deps: github.com/vibepilot/governor/internal/runtime, fmt, strconv, github.com/mark3labs/mcp-go/server, context, log, os, encoding/json, github.com/mark3labs/mcp-go/mcp
...
registry.go [253L]
  deps: github.com/mark3labs/mcp-go/client, github.com/vibepilot/governor/internal/runtime, github.com/mark3labs/mcp-go/client/transport, log, encoding/json, fmt, github.com/mark3labs/mcp-go/mcp, sync, context, time
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: strings, encoding/json, github.com/vibepilot/governor/internal/db, context, time, fmt, github.com/vibepilot/governor/internal/runtime
...
service.go [276L]
  deps: time, context, github.com/vibepilot/governor/internal/db, encoding/json, fmt
  exports: New
  API:
    cl ⊛ Config
    cl ⊛ Rule
...
client.go [640L]
  deps: encoding/json, github.com/coder/websocket, fmt, time, sync, context, github.com/vibepilot/governor/internal/runtime, log, net/url, net/http
  exports: NewClient
  API:
    cl ⊛ Client
    cl ⊛ Subscription
...
config.go [1161L]
  deps: context, encoding/json, fmt, log, sync, os, path/filepath
  exports: LoadConfig
  API:
    cl ⊛ SystemConfig
...
model_loader.go [217L]
  deps: context, fmt, os, path/filepath, encoding/json, github.com/vibepilot/governor/internal/db, time
...
db_tools.go [255L]
  deps: github.com/vibepilot/governor/internal/db, encoding/json, fmt, regexp, context, strings
...
file_tools.go [177L]
  deps: encoding/json, fmt, path/filepath, strings, context, os
...
registry.go [94L]
  deps: net/http, time, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/runtime
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: os, encoding/json, bytes, time, fmt, strings, os/exec, path/filepath, context
...
web_tools.go [231L]
  deps: context, github.com/vibepilot/governor/internal/runtime, io, net/http, net/url, strings, fmt, encoding/json
...
vault.go [337L]
  deps: encoding/base64, crypto/sha256, encoding/json, fmt, log, sync, crypto/rand, github.com/vibepilot/governor/internal/db, crypto/aes, crypto/cipher, context, io, golang.org/x/crypto/pbkdf2, os, time
...
server.go [303L]
  deps: context, encoding/json, io, github.com/vibepilot/governor/internal/runtime, fmt, log, strings, time, encoding/hex, crypto/hmac, net/http, crypto/sha256
