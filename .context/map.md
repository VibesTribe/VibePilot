# VibePilot Code Map
# Generated: 2026-05-20T04:45:33Z | Commit: 1da46630
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [68L]
  deps: syscall, context, log, os, fmt, os/signal, github.com/vibepilot/governor/internal/db, time
  API:
    fn main()
...
content_fetcher.go [48L]
  deps: os, net/http, context, fmt, io, path/filepath, log
  API:
...
handlers_council.go [522L]
  deps: fmt, encoding/json, context, time, sync, os, github.com/vibepilot/governor/internal/gitree, log, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, errors
...
handlers_maint.go [664L]
  deps: log, encoding/json, github.com/vibepilot/governor/internal/runtime, context, time, strings, os/exec, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/gitree, fmt
...
handlers_plan.go [745L]
  deps: time, github.com/vibepilot/governor/internal/gitree, path/filepath, encoding/json, strings, log, github.com/vibepilot/governor/internal/runtime, fmt, context, os, github.com/vibepilot/governor/internal/db
  API:
...
handlers_research.go [1193L]
  deps: strings, os/exec, github.com/vibepilot/governor/internal/db, log, os, fmt, context, github.com/vibepilot/governor/internal/runtime, time, encoding/json
...
handlers_task.go [1966L]
  deps: os, context, time, strings, encoding/json, fmt, log, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/db, path/filepath, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/security
...
handlers_testing.go [1495L]
  deps: os/exec, strings, encoding/json, bytes, github.com/vibepilot/governor/internal/db, time, github.com/vibepilot/governor/internal/runtime, context, path/filepath, fmt, log, os, github.com/vibepilot/governor/internal/gitree
...
helpers.go [227L]
  deps: github.com/vibepilot/governor/internal/db, context, encoding/json, log, strings
  API:
...
helpers_record.go [48L]
  deps: context, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, fmt, encoding/json
  API:
...
main.go [907L]
  deps: github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/mcp, context, github.com/vibepilot/governor/internal/vault, time, github.com/vibepilot/governor/internal/dag, github.com/vibepilot/governor/internal/pgnotify, github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/kb, syscall, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/visualqa, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/webhooks, fmt, log, encoding/json, path/filepath, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, os, os/signal, github.com/vibepilot/governor/internal/tools, github.com/vibepilot/governor/internal/designpreview, github.com/vibepilot/governor/internal/security
  API:
    fn main()
...
recovery.go [443L]
  deps: github.com/vibepilot/governor/internal/core, log, fmt, github.com/vibepilot/governor/internal/db, context, github.com/vibepilot/governor/internal/runtime, encoding/json, time
  API:
...
smoke.go [252L]
  deps: bytes, io, os, log, time, fmt, net/http, encoding/json
  API:
...
startup_validate.go [508L]
  deps: strings, context, os/exec, time, encoding/json, os, fmt, log, path/filepath
  API:
...
validation.go [474L]
  deps: encoding/json, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, context, github.com/vibepilot/governor/internal/gitree, fmt, regexp, strconv, log, strings
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [200L]
  deps: crypto/cipher, fmt, io, net/http, crypto/rand, encoding/base64, bytes, crypto/sha256, crypto/aes, encoding/json, golang.org/x/crypto/pbkdf2, log, os
  API:
    fn main()
    cl ⊛ Secret
...
main.go [58L]
  deps: crypto/aes, encoding/base64, crypto/sha256, crypto/cipher, fmt, os, golang.org/x/crypto/pbkdf2
  API:
    fn main()

## governor/cmd/vault_encrypt/main.go
main.go [27L]
  deps: github.com/vibepilot/governor/internal/vault, os, log, fmt
  API:
    fn main()

## governor/internal/connectors/courier.go
courier.go [577L]
  deps: bytes, context, fmt, net/http, sync, os, time, os/exec, strings, encoding/json, io
...
runners.go [513L]
  deps: bufio, net/http, strings, github.com/vibepilot/governor/internal/vault, time, encoding/json, context, fmt, io, os/exec, github.com/vibepilot/governor/internal/runtime, bytes
...
analyst.go [116L]
  deps: time, fmt, context, encoding/json
  exports: NewAnalyst
  API:
    cl ⊛ Analyst
    if ⊛ DBInterface
...
state.go [299L]
  deps: fmt, encoding/json, time, context, sync
...
test_runner.go [296L]
  deps: strings, fmt, encoding/json, path/filepath, context, os/exec, time, os
...
engine.go [233L]
  deps: sync, time, log, context, fmt, strings
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
registry.go [123L]
  deps: os, sync, path/filepath, fmt
  exports: NewRegistry
  API:
    cl ⊛ Registry
...
postgres.go [693L]
  deps: time, github.com/jackc/pgx/v5/pgxpool, encoding/json, github.com/jackc/pgx/v5, github.com/jackc/pgx/v5/pgtype, fmt, reflect, strings, context, strconv, encoding/binary
  exports: NewPostgres
  API:
    cl ⊛ PostgresDB
...
supabase.go [285L]
  deps: encoding/json, io, net/http, net/url, time, bytes, regexp, strings, fmt, context
...
designpreview.go [176L]
  deps: github.com/google/uuid, encoding/json, time, context, fmt
...
generator.go [236L]
  deps: context, encoding/json, io, os/exec, path/filepath, fmt, net/http, time, os, encoding/base64, bytes
...
persist.go [94L]
  deps: path/filepath, time, os, fmt, context, github.com/google/uuid, encoding/json
...
gitree.go [976L]
  deps: context, path/filepath, os/exec, fmt, regexp, strings, log, bytes, os, encoding/json, time
  exports: New
  API:
...
managed_repo.go [310L]
  deps: time, os/exec, strings, context, path/filepath, fmt, os, log
...
worktree.go [416L]
  deps: log, os, strings, regexp, time, fmt, path/filepath, context
...
kb.go [344L]
  deps: context, fmt, strings, github.com/jackc/pgx/v5/pgxpool
...
maintenance.go [346L]
  deps: log, context, os, github.com/vibepilot/governor/pkg/types, strings, path/filepath, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/db, fmt
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: os, log, path/filepath, time, io, fmt, os/exec, context
  API:
...
validation.go [248L]
  deps: path/filepath, strings, os, time, encoding/json, log, fmt
  API:
...
executor.go [44L]
  deps: context, github.com/vibepilot/governor/internal/runtime, fmt, encoding/json
...
governor_server.go [211L]
  deps: log, context, encoding/json, github.com/mark3labs/mcp-go/server, github.com/mark3labs/mcp-go/mcp, fmt, os, strconv, github.com/vibepilot/governor/internal/runtime
...
registry.go [253L]
  deps: fmt, time, github.com/mark3labs/mcp-go/client, encoding/json, log, sync, github.com/vibepilot/governor/internal/runtime, context, github.com/mark3labs/mcp-go/client/transport, github.com/mark3labs/mcp-go/mcp
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: context, strings, fmt, time, github.com/vibepilot/governor/internal/db, encoding/json, github.com/vibepilot/governor/internal/runtime
...
service.go [302L]
  deps: github.com/vibepilot/governor/internal/db, encoding/json, time, fmt, context
  exports: New
  API:
    cl ⊛ Config
    cl ⊛ Rule
...
alert_dedup.go [216L]
  deps: context, os/exec, log, sync, strings, fmt, encoding/json
...
listener.go [291L]
  deps: fmt, context, log, time, github.com/vibepilot/governor/internal/runtime, github.com/jackc/pgx/v5, encoding/json
  exports: NewListener
  API:
    if ⊛ SSEBroadcaster
    cl ⊛ Listener
...
config.go [1415L]
  deps: path/filepath, os, context, encoding/json, fmt, log, sync
...
context_builder.go [609L]
  deps: encoding/json, context, path/filepath, os, strings, time, sync, fmt
...
credit_poller.go [347L]
  deps: fmt, encoding/json, github.com/vibepilot/governor/internal/notifications, time, sync, net/http, context, io, log, strings
...
decision.go [836L]
  deps: regexp, fmt, strings, encoding/json
...
model_loader.go [354L]
  deps: os, context, path/filepath, log, github.com/vibepilot/governor/internal/db, time, fmt, encoding/json
...
model_scanner.go [519L]
  deps: github.com/vibepilot/governor/internal/db, net/http, encoding/json, strings, context, io, fmt, sync, log, strconv, time
...
parallel.go [230L]
  deps: sync/atomic, log, context, fmt, sync
...
platform_tracker_v2.go [481L]
  deps: fmt, encoding/json, context, log, sync, time
...
research_action.go [561L]
  deps: context, github.com/vibepilot/governor/internal/db, os, log, path/filepath, sync, encoding/json, fmt
...
router.go [808L]
  deps: encoding/json, log, sort, context, sync/atomic, github.com/vibepilot/governor/internal/db
...
session.go [286L]
  deps: strings, fmt, encoding/json, context, time
...
usage_tracker.go [1004L]
  deps: context, time, log, sync, fmt, encoding/json
...
db_tools.go [238L]
  deps: fmt, context, encoding/json, github.com/vibepilot/governor/internal/db, regexp
...
file_tools.go [177L]
  deps: context, encoding/json, os, fmt, path/filepath, strings
...
registry.go [94L]
  deps: github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/vault, net/http, time
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: bytes, strings, time, os, os/exec, context, encoding/json, fmt, path/filepath
...
vault_tools.go [41L]
  deps: fmt, encoding/json, context, github.com/vibepilot/governor/internal/vault
...
web_tools.go [231L]
  deps: encoding/json, strings, net/http, io, github.com/vibepilot/governor/internal/runtime, fmt, context, net/url
...
vault.go [506L]
  deps: github.com/vibepilot/governor/internal/db, context, crypto/rand, time, encoding/json, log, io, encoding/base64, os, crypto/aes, fmt, crypto/cipher, golang.org/x/crypto/pbkdf2, sync, crypto/sha256
...
audit.go [484L]
  deps: time, strings, fmt, encoding/json, encoding/base64, context, os
  API:
    cl ⊛ AuditResult
    cl ⊛ AuditIssue
...
baseline.go [164L]
  deps: context, os, encoding/json, bytes, path/filepath, os/exec, time, fmt
  API:
    cl ⊛ BaselineEntry
    ty ⊛ BaselineManifest
...
capture.go [513L]
  deps: encoding/json, path/filepath, context, os, time, strconv, os/exec, fmt
  API:
    cl ⊛ CaptureResult
    cl ⊛ UIIssue
    cl ⊛ UICaptureReport
...
compare.go [450L]
  deps: time, bytes, strings, io, fmt, encoding/json, encoding/base64, context, net/http, os
  API:
    cl ⊛ VisionProvider
...
db.go [78L]
  deps: os, fmt, github.com/jackc/pgx/v5, github.com/jackc/pgx/v5/pgxpool, context, database/sql
...
fixengine.go [437L]
  deps: encoding/json, os/exec, context, fmt, path/filepath, os, strings, regexp, time
...
visualqa.go [666L]
  deps: github.com/jackc/pgx/v5, context, regexp, github.com/google/uuid, encoding/json, strings, time, fmt
  exports: NewVisualQA
  API:
    cl ⊛ Config
...
chat_usage.go [70L]
  deps: net/http, io, log, encoding/json
  API:
    cl chatUsageRequest

## governor/internal/webhooks/designpreview.go
designpreview.go [204L]
  deps: context, fmt, log, net/http, encoding/json
  API:
    if ⊛ DesignPreviewer
...
github.go [293L]
  deps: github.com/vibepilot/governor/internal/db, encoding/json, context, path/filepath, strings, log
...
server.go [2645L]
  deps: crypto/sha256, encoding/hex, log, strconv, net/http, time, context, github.com/vibepilot/governor/internal/runtime, strings, encoding/json, io, crypto/hmac, path/filepath, os/exec, github.com/vibepilot/governor/internal/reviewitems, fmt, os
...
visualqa.go [216L]
  deps: io, log, net/http, context, time, fmt, encoding/json
  API:
    if ⊛ VisualQARunner
