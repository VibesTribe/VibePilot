# VibePilot Code Map
# Generated: 2026-05-14T22:45:54Z | Commit: d71e731d
# Auto-generated. Run build.sh to regenerate.

## governor/cmd/cleanup/main.go
main.go [68L]
  deps: fmt, time, syscall, os, context, log, os/signal, github.com/vibepilot/governor/internal/db
  API:
    fn main()
...
content_fetcher.go [48L]
  deps: path/filepath, net/http, io, context, log, os, fmt
  API:
...
handlers_council.go [522L]
  deps: github.com/vibepilot/governor/internal/db, fmt, time, errors, os, sync, context, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime, encoding/json, log
...
handlers_maint.go [664L]
  deps: github.com/vibepilot/governor/internal/runtime, os/exec, strings, context, fmt, github.com/vibepilot/governor/internal/gitree, encoding/json, time, log, github.com/vibepilot/governor/internal/db
...
handlers_plan.go [745L]
  deps: log, encoding/json, os, github.com/vibepilot/governor/internal/runtime, fmt, strings, github.com/vibepilot/governor/internal/gitree, context, path/filepath, time, github.com/vibepilot/governor/internal/db
  API:
...
handlers_research.go [463L]
  deps: time, sync, encoding/json, github.com/vibepilot/governor/internal/runtime, context, log, fmt, github.com/vibepilot/governor/internal/db
...
handlers_task.go [1955L]
  deps: github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/db, strings, time, github.com/vibepilot/governor/internal/security, github.com/vibepilot/governor/internal/runtime, context, path/filepath, encoding/json, github.com/vibepilot/governor/internal/connectors, os, fmt, log, github.com/vibepilot/governor/internal/core
...
handlers_testing.go [1451L]
  deps: github.com/vibepilot/governor/internal/db, time, os/exec, encoding/json, os, bytes, github.com/vibepilot/governor/internal/gitree, fmt, github.com/vibepilot/governor/internal/runtime, log, path/filepath, strings, context
...
helpers.go [213L]
  deps: strings, github.com/vibepilot/governor/internal/db, encoding/json, context, log
  API:
...
helpers_record.go [48L]
  deps: encoding/json, fmt, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/runtime, context
  API:
...
main.go [906L]
  deps: github.com/vibepilot/governor/internal/memory, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/webhooks, github.com/vibepilot/governor/internal/pgnotify, os/signal, syscall, os, github.com/vibepilot/governor/internal/dag, github.com/vibepilot/governor/internal/core, github.com/vibepilot/governor/internal/vault, github.com/vibepilot/governor/internal/designpreview, log, path/filepath, github.com/vibepilot/governor/internal/connectors, github.com/vibepilot/governor/internal/mcp, github.com/vibepilot/governor/internal/security, time, github.com/vibepilot/governor/internal/visualqa, context, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/kb, encoding/json, github.com/vibepilot/governor/internal/tools, fmt
  API:
    fn main()
...
recovery.go [443L]
  deps: encoding/json, time, log, github.com/vibepilot/governor/internal/db, fmt, context, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/core
  API:
...
smoke.go [252L]
  deps: time, log, encoding/json, fmt, net/http, bytes, os, io
  API:
...
startup_validate.go [508L]
  deps: os, strings, path/filepath, context, fmt, log, time, encoding/json, os/exec
  API:
...
validation.go [474L]
  deps: github.com/vibepilot/governor/internal/db, regexp, github.com/vibepilot/governor/internal/runtime, fmt, log, github.com/vibepilot/governor/internal/gitree, strconv, strings, encoding/json, context
  API:
    cl ⊛ TaskData
    cl ⊛ ValidationError
      fn ⊛ Error() → string
...
main.go [200L]
  deps: bytes, crypto/aes, crypto/cipher, crypto/rand, crypto/sha256, os, encoding/json, encoding/base64, fmt, net/http, golang.org/x/crypto/pbkdf2, io, log
  API:
    fn main()
    cl ⊛ Secret
...
courier.go [577L]
  deps: os/exec, sync, fmt, strings, net/http, time, bytes, os, context, io, encoding/json
...
runners.go [513L]
  deps: fmt, bufio, bytes, encoding/json, os/exec, io, time, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/vault, context, strings, net/http
...
state.go [299L]
  deps: encoding/json, time, fmt, sync, context
...
test_runner.go [296L]
  deps: os/exec, encoding/json, time, os, context, fmt, strings, path/filepath
...
engine.go [233L]
  deps: time, strings, context, sync, log, fmt
  exports: NewEngine
  API:
    cl ⊛ NodeOutput
    if ⊛ NodeExecutor
...
postgres.go [685L]
  deps: encoding/binary, fmt, github.com/jackc/pgx/v5, context, strings, github.com/jackc/pgx/v5/pgtype, time, github.com/jackc/pgx/v5/pgxpool, encoding/json, strconv
  exports: NewPostgres
  API:
    cl ⊛ PostgresDB
...
supabase.go [285L]
  deps: bytes, encoding/json, io, time, fmt, regexp, net/http, context, strings, net/url
...
designpreview.go [161L]
  deps: encoding/json, github.com/google/uuid, fmt, context, time
...
generator.go [236L]
  deps: context, os, os/exec, encoding/base64, net/http, bytes, time, io, path/filepath, fmt, encoding/json
...
persist.go [94L]
  deps: github.com/google/uuid, os, context, fmt, path/filepath, time, encoding/json
...
gitree.go [976L]
  deps: os, os/exec, path/filepath, strings, time, context, bytes, regexp, encoding/json, fmt, log
  exports: New
  API:
...
managed_repo.go [310L]
  deps: fmt, strings, time, path/filepath, os, context, log, os/exec
...
worktree.go [416L]
  deps: fmt, log, strings, os, regexp, context, time, path/filepath
...
maintenance.go [346L]
  deps: github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/db, strings, fmt, os, path/filepath, context, github.com/vibepilot/governor/pkg/types, log
  exports: New
  API:
    ty ⊛ RiskLevel
    ty ⊛ ChangeType
...
sandbox.go [165L]
  deps: path/filepath, fmt, log, io, os/exec, time, context, os
  API:
...
validation.go [248L]
  deps: log, encoding/json, os, path/filepath, strings, time, fmt
  API:
...
governor_server.go [211L]
  deps: github.com/mark3labs/mcp-go/mcp, context, os, strconv, github.com/vibepilot/governor/internal/runtime, log, encoding/json, github.com/mark3labs/mcp-go/server, fmt
...
registry.go [253L]
  deps: sync, github.com/mark3labs/mcp-go/mcp, log, time, github.com/mark3labs/mcp-go/client/transport, fmt, encoding/json, context, github.com/mark3labs/mcp-go/client, github.com/vibepilot/governor/internal/runtime
  exports: NewRegistry
  API:
    cl ⊛ ToolBinding
    cl ⊛ Registry
...
compactor.go [248L]
  deps: strings, context, encoding/json, time, fmt, github.com/vibepilot/governor/internal/runtime, github.com/vibepilot/governor/internal/db
...
service.go [302L]
  deps: time, encoding/json, context, github.com/vibepilot/governor/internal/db, fmt
  exports: New
  API:
    cl ⊛ Config
    cl ⊛ Rule
...
listener.go [246L]
  deps: time, github.com/vibepilot/governor/internal/runtime, encoding/json, fmt, log, github.com/jackc/pgx/v5, context
  exports: NewListener
  API:
    if ⊛ SSEBroadcaster
    cl ⊛ Listener
...
config.go [1415L]
  deps: encoding/json, context, fmt, os, path/filepath, log, sync
...
connector_tracker.go [283L]
  deps: sync, encoding/json, log, time, context
...
context_builder.go [609L]
  deps: time, context, encoding/json, sync, os, fmt, path/filepath, strings
...
credit_poller.go [193L]
  deps: strings, time, context, log, sync, net/http, io, encoding/json, fmt
...
decision.go [805L]
  deps: strings, encoding/json, fmt, regexp
...
model_loader.go [354L]
  deps: log, os, github.com/vibepilot/governor/internal/db, encoding/json, fmt, context, path/filepath, time
...
model_scanner.go [519L]
  deps: net/http, encoding/json, sync, github.com/vibepilot/governor/internal/db, fmt, log, io, strconv, context, strings, time
...
platform_tracker.go [361L]
  deps: sync, context, encoding/json, log, time
...
platform_tracker_v2.go [481L]
  deps: context, log, encoding/json, fmt, time, sync
...
research_action.go [561L]
  deps: log, github.com/vibepilot/governor/internal/db, fmt, sync, os, context, path/filepath, encoding/json
...
router.go [808L]
  deps: sync/atomic, github.com/vibepilot/governor/internal/db, log, context, encoding/json, sort
...
session.go [286L]
  deps: fmt, context, time, encoding/json, strings
...
usage_tracker.go [1004L]
  deps: encoding/json, fmt, sync, context, time, log
...
db_tools.go [238L]
  deps: context, encoding/json, regexp, github.com/vibepilot/governor/internal/db, fmt
...
file_tools.go [177L]
  deps: encoding/json, strings, path/filepath, os, context, fmt
...
registry.go [94L]
  deps: github.com/vibepilot/governor/internal/db, github.com/vibepilot/governor/internal/vault, net/http, time, github.com/vibepilot/governor/internal/gitree, github.com/vibepilot/governor/internal/runtime
  exports: RegisterAll
  API:
    cl ⊛ Dependencies
    fn init()
...
sandbox_tools.go [245L]
  deps: bytes, fmt, time, encoding/json, os, path/filepath, os/exec, context, strings
...
web_tools.go [231L]
  deps: github.com/vibepilot/governor/internal/runtime, net/http, context, encoding/json, io, net/url, fmt, strings
...
vault.go [506L]
  deps: crypto/sha256, fmt, io, crypto/rand, crypto/cipher, log, os, time, github.com/vibepilot/governor/internal/db, crypto/aes, encoding/json, golang.org/x/crypto/pbkdf2, sync, context, encoding/base64
...
audit.go [484L]
  deps: context, encoding/base64, fmt, strings, time, encoding/json, os
  API:
    cl ⊛ AuditResult
    cl ⊛ AuditIssue
...
baseline.go [164L]
  deps: path/filepath, os, os/exec, encoding/json, fmt, bytes, context, time
  API:
    cl ⊛ BaselineEntry
    ty ⊛ BaselineManifest
...
capture.go [513L]
  deps: time, path/filepath, os, fmt, context, strconv, encoding/json, os/exec
  API:
    cl ⊛ CaptureResult
    cl ⊛ UIIssue
    cl ⊛ UICaptureReport
...
compare.go [450L]
  deps: encoding/json, os, strings, net/http, encoding/base64, fmt, bytes, time, io, context
  API:
    cl ⊛ VisionProvider
...
db.go [78L]
  deps: context, database/sql, github.com/jackc/pgx/v5, os, github.com/jackc/pgx/v5/pgxpool, fmt
...
fixengine.go [437L]
  deps: strings, os, time, context, encoding/json, fmt, path/filepath, regexp, os/exec
...
visualqa.go [648L]
  deps: time, github.com/google/uuid, regexp, github.com/jackc/pgx/v5, encoding/json, context, fmt, strings
  exports: NewVisualQA
  API:
    cl ⊛ Config
...
designpreview.go [177L]
  deps: context, net/http, fmt, log, encoding/json
  API:
    if ⊛ DesignPreviewer
...
github.go [282L]
  deps: github.com/vibepilot/governor/internal/db, context, path/filepath, strings, encoding/json, log
...
server.go [2158L]
  deps: fmt, path/filepath, os/exec, time, strconv, log, os, crypto/hmac, crypto/sha256, encoding/json, net/http, context, encoding/hex, github.com/vibepilot/governor/internal/runtime, strings, io
...
visualqa.go [216L]
  deps: log, net/http, time, io, context, fmt, encoding/json
  API:
    if ⊛ VisualQARunner
